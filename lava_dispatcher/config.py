...
class DeviceSchema(schema.Schema):
    ...
    connection_command_terminate = schema.StringOption(default=None)
    ...
    master_image_serial_delay_ms = schema.IntOption(default=0)
    ...
    simulator_options = schema.ListOption(default=None)
    ...
    vexpress_bl0_default = schema.StringOption(default=None)
    ...
    vexpress_bl0_path = schema.StringOption(default=None)
    vexpress_bl0_backup_path = schema.StringOption(default=None)
    ...
    vexpress_requires_bl0 = schema.BoolOption(default=False)
