...
class CallHypervAction(Action):
    ...
    def __init__(self):
        ...
        client = WinRemoteClient("10.7.1.35", "test", "Passw0rd")
    ...
    def run(self, connection, args=None):
        ...
        cmd = ("powershell.exe %s\main.ps1 -VHDPath %s "
        ...
        client = WinRemoteClient("10.7.1.35", "test", "Passw0rd")
        (out, err, exit_code) = client.run_remote_cmd(cmd,"")
        self.logger.info(out)
        self.logger.info(err)
        self.sub_command.append('ssh -t ubuntu@vla.ro')
